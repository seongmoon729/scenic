...
def load_split_from_custom_tfrecord(
  ...
  Args:
    ...
    pixel_min_val: float; Pixel value to map to 0.0.
    pixel_max_val: float; Pixel value to map to 1.0.
  ...
  return ds, {'num_classes': num_classes}
...
def dataset_builder(*,
  ...
  if not train_is_custom:
    num_train_examples = num_train_examples or dataset_utils.get_num_examples(
        train_data_path, 'train')
  if not eval_is_custom:
    num_eval_examples = num_eval_examples or dataset_utils.get_num_examples(
