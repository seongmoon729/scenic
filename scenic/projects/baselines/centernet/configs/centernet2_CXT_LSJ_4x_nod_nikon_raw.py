...
def get_config():
  ...
  config.dataset_configs.train_data_path = 'nod/nikon_raw:2.0.1' # ❗️❗️❗️❗️
  config.dataset_configs.test_data_path = 'nod/nikon_raw:2.0.1' # ❗️❗️❗️❗️
  ...
  config.model.max_val = 2**14 - 1
  config.model.min_val = 600
